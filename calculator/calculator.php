            ...
            <div class="modal_main">
                ...
                <div class="win2">
                    <div class="smallWall">
                        ...
                        <p class='modalDescr'>Экономичность: Помещение с потолком высотой 2.5 метра может быть более
                            экономичным в плане использования материалов для отделки и отопления/охлаждения, так как
                            объем помещения меньше.
                            <br> Уют и безопасность: Ниже потолок создает более уютную атмосферу и помогает уменьшить
                            ветровые потоки, особенно в больших помещениях, обеспечивая ощущение комфорта и
                            безопасности.<br/>
                        ...
                        <div class="price">
                            ...
                            <button class="modal_btn" id="smallWallBtn"
                                    onclick="activeCircleLine('circleWall', 'lineWall', 'emptyWall')">Добавить
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="win2">
                    <div class="bigWall">
                        ...
                        <p class='modalDescr'>Простор и свобода: Высокие потолки дают ощущение простора и свободы в
                            помещении, делая его более величественным и впечатляющим.
                            <br> Комфорт в использовании: Помещение с потолком высотой 2.8 метров может быть более
                            комфортным для проведения деятельности, требующей вертикального пространства, например, для
                            подвешивания светильников или наличия высокой мебели.
                        </p>
                        ...
                        <div class="price">
                            ...
                            <button class="modal_btn" id="bigWallBtn"
                                    onclick="activeCircleLine('circleWall', 'lineWall', 'emptyWall')">Добавить
                            </button>
                        </div>
                    </div>
            ...
            <div class="modal_main">
                ...
                <div class="win2">
                    <div class='flor'>
                        ...
                        <p class='modalDescr'>Кровля — верхний элемент покрытия здания, подвергающийся атмосферным
                            воздействиям. Главной её функцией является защита внутренних помещений от атмосферных
                            осадков и воздействий. </p>
                        <div class="material">
                            <div class="contNames">
                                <h2>Материалы:</h2>
                                <ul>
                        ...
                        <div class="prices">
                            <h3 class="summ"></h3>
                            <button class="modal_btn" id="roofPrice"
                                    onclick="activeCircleLine('circleFloor', 'lineFloor', 'emptyFloor')">Добавить
                            </button>
            ...
            <div class="modal_main">
                ...
                <div class="win2">
                    <div class='mineral'>
                        ...
                        <p class='modalDescr'>Винтовая свая — свая, состоящая из металлического наконечника с лопастью
                            или многовитковой спиралью и трубчатого металлического ствола, погружаемая в грунт методом
                            завинчивания в сочетании с вдавливанием. </p>
                        ...
                        <div class="price">
                            <h3 id="totalCost"></h3>
                            <button class="modal_btn" id="vintPricePlus"
                                    onclick="activeCircleLine('circleFoundation', 'lineFoundation', 'emptyFoundation')">
                                Добавить
                            </button>
                        </div>
                    </div>
                ...
                <div class="win2">
                    <div class='penopolist mineral'>
                        ...
                        <p class='modalDescr'> Железобетонные сваи - это конструкция вертикального или наклонного
                            расположения, погружаемая в грунт, или формируемая уже в самом грунте – путем армирования и
                            заливки скважины бетонным раствором.</p>
                        ...
                        <div class="price">
                            ...
                            <button class="modal_btn" id="jelezPricePlus"
                                    onclick="activeCircleLine('circleFoundation', 'lineFoundation', 'emptyFoundation')">
                                Добавить
                            </button>
                        </div>
            ...
            <div class="modal_main">
                ...
                <div class="win2">
                    <div class='frstObv'>
                        ...
                        <p class='modalDescr'>Применяется для горизонтальной обвязки на паллетах упаковок с стеклотарой,
                            стройматериалами (кирпич, плитка), сельхозпродукцией и др. при использовании упаковочных
                            защитных уголков.</p>


                        <div class="price">
                            <h3 id="gorizTtl"></h3>
                            <button class="modal_btn" id="GorizObvDob"
                                    onclick="activeCircleLine('circleSupport', 'lineSupport', 'emptySupport')">Добавить
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="win2">
                    <div class='scndObv'>
                        ...
                        <p class='modalDescr'>Вертикальная обвязка с использованием картонных защитных уголков
                            применяется для
                        ...
                        <div class="material">
                            <div class="contName">
                                ...
                                <div class="price">
                                    <h3 id="vertTtl"></h3>
                                    <button class="modal_btn" id="vertObvDob"
                                            onclick="activeCircleLine('circleSupport', 'lineSupport', 'emptySupport')">
                                        Добавить
                                    </button>
                                </div>
                            </div>
