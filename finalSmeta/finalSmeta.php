...
<body>
  ...
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
            ...
            <p class="minorMaterials">Фундамент теплового контура<span class="minorMatPrice">139 000 руб.</span></p>
            <p class="minorMaterials">Фундамент крыльца<span class="minorMatPrice">13 000 руб.</span></p>
            <p class="minorMaterials">Фундамент террасы<span class="minorMatPrice">13 000 руб.</span></p>
        </div>
    </div>
